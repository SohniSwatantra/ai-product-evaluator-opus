...
exports.initAXModelTables = initAXModelTables;
exports.getEnabledAXModelConfigs = getEnabledAXModelConfigs;
exports.getAllAXModelConfigs = getAllAXModelConfigs;
exports.createAXModelConfig = createAXModelConfig;
exports.updateAXModelConfig = updateAXModelConfig;
exports.deleteAXModelConfig = deleteAXModelConfig;
exports.getAXModelEvaluations = getAXModelEvaluations;
exports.getAXModelEvaluation = getAXModelEvaluation;
exports.upsertAXModelEvaluation = upsertAXModelEvaluation;
exports.getAXCouncilResult = getAXCouncilResult;
exports.saveAXCouncilResult = saveAXCouncilResult;
exports.initCreditTables = initCreditTables;
exports.getUserCredits = getUserCredits;
exports.addUserCredits = addUserCredits;
exports.deductUserCredits = deductUserCredits;
exports.getUserCreditTransactions = getUserCreditTransactions;
exports.seedAXModelConfigs = seedAXModelConfigs;
exports.claimEvaluationByJobId = claimEvaluationByJobId;
exports.getShowcaseEvaluationIds = getShowcaseEvaluationIds;
exports.getShowcaseEvaluations = getShowcaseEvaluations;
exports.isShowcaseEvaluation = isShowcaseEvaluation;
exports.addShowcaseEvaluation = addShowcaseEvaluation;
exports.removeShowcaseEvaluation = removeShowcaseEvaluation;
exports.getShowcaseEvaluationsForAdmin = getShowcaseEvaluationsForAdmin;
exports.initVoucherTables = initVoucherTables;
...
exports.toggleVoucherActive = toggleVoucherActive;
exports.hasUserRedeemedVoucher = hasUserRedeemedVoucher;
 ...
 */
async function saveEvaluation(evaluation, userId) {
    try {
 ...
 */
async function createEvaluationJob(jobId, url, demographics, userId) {
    try {
        await sql `
 ...
 */
async function getEvaluationJob(jobId) {
    try {
        const results = await sql `
 ...
 */
async function initAXModelTables() {
    try {
 ...
 */
async function getEnabledAXModelConfigs() {
    try {
        const results = await sql `
 ...
 */
async function getAllAXModelConfigs() {
    try {
        const results = await sql `
      SELECT id, model_id, display_name, provider, openrouter_model_id, is_enabled, sort_order, created_at
      FROM ax_model_configs
 ...
 */
async function createAXModelConfig(config) {
    try {
        const result = await sql `
 ...
 */
async function updateAXModelConfig(id, config) {
    try {
        const result = await sql `
 ...
 */
async function deleteAXModelConfig(id) {
    try {
        const result = await sql `
 ...
 */
async function getAXModelEvaluations(evaluationId) {
    try {
        const results = await sql `
 ...
 */
async function getAXModelEvaluation(evaluationId, modelId) {
    try {
        const results = await sql `
      SELECT id, evaluation_id, model_id, ax_score, anps, ax_factors, agent_accessibility,
             ax_recommendations, raw_response, status, error_message, created_at, completed_at
 ...
 */
async function upsertAXModelEvaluation(evaluation) {
    try {
        const result = await sql `
 ...
 */
async function getAXCouncilResult(evaluationId) {
    try {
        const results = await sql `
 ...
 */
async function saveAXCouncilResult(result) {
    try {
 ...
 */
async function initCreditTables() {
    try {
 ...
 */
async function getUserCredits(userId, userEmail) {
    try {
        const results = await sql `
 ...
 */
async function addUserCredits(userId, amount, description, stripeSessionId) {
    try {
 ...
 */
async function deductUserCredits(userId, amount, description) {
    try {
 ...
 */
async function getUserCreditTransactions(userId, limit = 50) {
    try {
        const results = await sql `
 ...
 */
async function seedAXModelConfigs() {
    try {
 ...
 */
async function claimEvaluationByJobId(jobId, userId) {
    try {
 ...
 */
async function getShowcaseEvaluationIds() {
    try {
        const results = await sql `
 ...
 */
async function isShowcaseEvaluation(evaluationId) {
    try {
        const results = await sql `
 ...
 */
async function addShowcaseEvaluation(evaluationId, displayOrder) {
    try {
 ...
 */
async function removeShowcaseEvaluation(evaluationId) {
    try {
        await sql `
 ...
 */
async function getShowcaseEvaluationsForAdmin() {
    try {
        const results = await sql `
      SELECT
        s.id,
 ...
 */
function generateVoucherCode(prefix = "BETA") {
 ...
 */
async function createVoucher(creditsAmount, maxUses = null, expiresAt = null, customCode) {
    try {
 ...
 */
async function hasUserRedeemedVoucher(voucherId, userId) {
    try {
        const results = await sql `
 ...
 */
async function getUserVoucherRedemptions(userId) {
    try {
        const results = await sql `
...
async function redeemVoucher(code, userId) {
    ...
    `;
        // Add credits to user's account
        const newBalance = await addUserCredits(userId, voucher.credits_amount, `Voucher redemption: ${voucher.code}`);
