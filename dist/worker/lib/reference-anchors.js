...
exports.REFERENCE_ANCHORS = void 0;
exports.getAnchorsByTier = getAnchorsByTier;
exports.getAllAnchorStatements = getAllAnchorStatements;
exports.REFERENCE_ANCHORS = [
 ...
 */
function getAnchorsByTier(tier) {
    return exports.REFERENCE_ANCHORS.filter((anchor) => anchor.tier === tier);
}
/**
 * Get all reference anchor statements as an array
 */
function getAllAnchorStatements() {
    return exports.REFERENCE_ANCHORS.map((anchor) => anchor.statement);
}
